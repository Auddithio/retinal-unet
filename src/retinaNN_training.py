...
from tensorflow.keras.layers import Input, concatenate, Conv2D, MaxPooling2D, UpSampling2D, Reshape, Permute, Activation, Dropout
...
def get_unet(n_ch,patch_height,patch_width):
    ...
    up1 = Conv2D(64, 3, activation='relu', padding='same', data_format='channels_first')(UpSampling2D(size=(2, 2))(conv3))
    up1 = concatenate([conv2,up1],axis=1)
    conv4 = Conv2D(64, (3, 3), activation='relu', padding='same',data_format='channels_first')(up1)
    conv4 = Dropout(0.2)(conv4)
    conv4 = Conv2D(64, (3, 3), activation='relu', padding='same',data_format='channels_first')(conv4)
    #
    up2 = Conv2D(32, 3, padding='same', data_format='channel_first', activation='relu')(UpSampling2D(size=(2, 2))(conv4))
...
# visualize(group_images(patches_masks_train[0:N_sample,:,:,:],5),'./'+name_experiment+'/'+"sample_input_masks")#.show()show
